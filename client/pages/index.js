  ...
  if (events === undefined || reqErr) {
    return (
      <div className="handle-error">
        <center>
          <h1 style={{ color: "red", margin: "20rem auto" }}>
            {" "}
            Can't Load page <br /> Error {reqErr.message}
          </h1>
        </center>
      </div>
    );
            ...
            >
              ...
              >
                ...
                <div className="card-text">
                  ...
                  <p className="ticketleft" style={Styles(event.ticketsLeft)}>
                    Ticket Left: {event.ticketsLeft}
                  </p>
  ...
  return (
    <div>
      ...
      <div className="container content">
        <div className="row">{events.length > 0 && eventCard}</div>
        {(events.length <= 0 || !IsValid) && (
          <div className="container no-event">
            <br />
            <center>No Event Available. Try to Create One</center> <br />{" "}
            <Link href="/events/new">
              <a className="btn btn-success">Create Event</a>
            </Link>{" "}
          </div>
        )}
      </div>
